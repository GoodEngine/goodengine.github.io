...
function preLoadPageToCurrentHash() {
	...
	if (typeof currentSearch.item !== "undefined") {
		...
		if (typeof searchResult !== "undefined") {
			...
			textMain += '<a href="https://twitter.com/goodengine01/lists/goodengine" target="_blank"><span class="logoImage"></span></a>';
			textMain += '<a href="https://goo.gl/vFftYE" target="_blank"><span class="titlePage">Good Engine</span></a>';
			textMain += '</div>';
			...
			textMain += '<a href="http://goodengine.github.io" target="_blank"><span id="footerInfo">GoodEngine &copy; 2017</span></a>';
			textMain += '<a href="https://www.inoreader.com/feed/http://feeds.feedburner.com/goodengine" target="_blank"><span id="footerRSS"></span></a>';
			textMain += '</div>';
			textMain += '</footer>';
			...
			textHTML += '		<title>Good Engine - ' + searchResult.title + '</title>\n';
			...
			textHTML += '		<meta name="keywords" content="goodengine01, ' + searchResult.title.split("  ").join(" ").split(" ").join(", ") + '" />\n';
			textHTML += '		<meta property="og:type" content="article" />\n';
			textHTML += '		<meta property="og:title" content="Good Engine - Save big on top quality items on shopping" />\n';
			...
			textHTML += '		<meta property="og:url" content="https://goodengine.github.io/#' + searchResult.search + '" />\n';
			textHTML += '		<meta name="twitter:card" content="summary_large_image" />\n';
			textHTML += '		<meta name="twitter:site" content="@goodengine01" />\n';
			textHTML += '		<link rel="canonical" href="https://goodengine.github.io/#' + searchResult.search + '" />\n';
			...
			textHTML += '		<meta name="apple-mobile-web-app-title" content="Good Engine" />\n';
			textHTML += '		<meta name="application-name" content="Good Engine" />\n';
			...
			textHTML += '		<link rel="alternate" type="application/rss+xml" title="RSS Feed for Good Engine" href="http://feeds.feedburner.com/goodengine" />\n';
			textHTML += '		<link rel="stylesheet" href="css/main.css" />\n';
			textHTML += '		<script>(function(i,s,o,g,r,a,m){i["GoogleAnalyticsObject"]=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,"script","https://www.google-analytics.com/analytics.js","ga");ga("create", "UA-91676516-2", "auto");ga("send", "pageview");</script>\n';
			textHTML += '	</head>\n';
			textHTML += '	<body>\n';
	...
	if (App.currentHash !== "") {
		...
		if (typeof searchResult !== "undefined") {
			...
			$("meta[name='keywords']").attr("content", "goodengine01, " + searchResult.title.split("  ").join(" ").split(" ").join(", "));
			...
			$("meta[property='og\\:url']").attr("content", "https://goodengine.github.io/#" + searchResult.search);
...
function getRSSPage() {
	//openURL("https://goodengine.github.io/rss/rss.xml");
	//openURL("http://feedly.com/i/subscription/feed/https://goodengine.github.io/rss/rss.xml");
	//openURL("https://www.inoreader.com/feed/https://goodengine.github.io/rss/rss.xml");
	openURL("https://www.inoreader.com/feed/http://feeds.feedburner.com/goodengine");
}

function getgoodengineTelegramPage() {
	openURL("http://telegram.me/goodengine");
}
